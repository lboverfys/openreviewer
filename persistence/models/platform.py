...
class ModelUsageRequestRecord(Base):
    ...
    cost_reason: Mapped[str | None] = mapped_column(String(32))
    pricing_snapshot: Mapped[dict[str, str | None] | None] = mapped_column(JSON)
    usage_details: Mapped[dict[str, int] | None] = mapped_column(JSON)
