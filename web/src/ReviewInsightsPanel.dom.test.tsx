...
const data: NonNullable<DiagnosticReport["insights"]> = {
  requests: {request_count:3, estimated_cost_microusd:100, known_count:1, unknown_count:2, duration_sample_count:2,http_2xx_count:1,http_non_2xx_count:1,http_unknown_count:1,reserved_count:1,uncertain_count:1,settled_count:1,settled_priced_count:1,settled_reservation_microusd:150,settled_cost_microusd:100, missing_usage_count:1, missing_price_count:0, legacy_unknown_count:0, partial_cost_count:0},
